    ...
    <div className="grid items-center lg:grid-cols-2">
      <div className="mb-12 lg:mb-0">
        <div
         ...
         Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci iure vero non rerum, culpa aspernatur nostrum, dignissimos officiis blanditiis modi ipsa eos tempore molestias necessitatibus neque, quo consequatur autem debitis!
          </p>

          <div className="grid gap-x-6 md:grid-cols-3">
            <div className="mb-12 md:mb-0">
              <h2 className="text-dark mb-4 text-3xl font-bold">20k+</h2>
            ...
            <div className="">
              <h2 className="text-dark mb-4 text-3xl font-bold">24/7</h2>
              <h5 className="mb-0 text-lg font-medium text-neutral-500 dark:text-neutral-300">
                Security Uptime
              </h5>
            </div>

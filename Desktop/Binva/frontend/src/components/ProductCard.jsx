...
const ProductCard = ({ product, classNameName }) => {
  ...
  <section className="mb-32">
    <div
      ...
      <div className="flex flex-wrap items-center">
        ...
        <Link to={`/dashboard/shop/product/payment/${product.id}`}>
      <img
        src={
          product.avatar
        ...
        alt="title"
        classNameName="w-full rounded-t-lg lg:rounded-tr-none lg:rounded-bl-lg"
      />
     </Link>
        ...
        <div className="w-full shrink-0 grow-0 basis-auto lg:w-6/12 xl:w-8/12">
          <div className="px-6 py-12 md:px-12">
            <h2 className="mb-6 pb-2 text-4xl font-bold">{product.productname}</h2>
            ...
            <div className="flex flex-row items-center space-x-1 text-green-700 font-roboto font-bold italic">
            
            <p>Binva Secured: </p>
            <AiFillSafetyCertificate className="text-green-700 font-bold"/>
            </div>
          
             <button type="button"
             onClick={()=>navigate(`/dashboard/shop/product/payment/${product.id}`)}
